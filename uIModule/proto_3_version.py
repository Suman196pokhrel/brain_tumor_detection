...
"color: rgb(255, 255, 255);")
        ...
        self.label_7.setPixmap(QtGui.QPixmap(":/newPrefix/download.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Brain Tumor Detector"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt;\">MRI Image</span></p></body></html>"))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Add image  . . . "))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Patient Details</span></p></body></html>"))
        ...
        self.lineEdit_4.setPlaceholderText(_translate("MainWindow", "Last name  . . . "))
        self.lineEdit_5.setPlaceholderText(_translate("MainWindow", "Age . . . "))
        self.lineEdit_6.setPlaceholderText(_translate("MainWindow", "Contact number  . . . "))
        self.lineEdit_7.setPlaceholderText(_translate("MainWindow", "Address  . . . "))
        self.radioButton.setText(_translate("MainWindow", "Add patients data to Dataset"))
        self.pushButton_2.setText(_translate("MainWindow", "Start Detection"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">Analysis Results</span></p></body></html>"))
        ...
        self.label_5.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt;\">Run Operations On Database</span></p></body></html>"))
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">Search Patient ID</span></p></body></html>"))
        self.lineEdit_8.setPlaceholderText(_translate("MainWindow", "First name  . . . "))
        self.lineEdit_9.setPlaceholderText(_translate("MainWindow", "Last name  . . . "))
        ...
        self.lineEdit_11.setPlaceholderText(_translate("MainWindow", "Contact num"))
        self.lineEdit_12.setPlaceholderText(_translate("MainWindow", "Address"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Patient Records"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Model Analysis"))
